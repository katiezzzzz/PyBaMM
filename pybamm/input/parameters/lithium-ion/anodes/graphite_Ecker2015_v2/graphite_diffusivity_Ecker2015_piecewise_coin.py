...
def graphite_diffusivity_Ecker2015_piecewise_coin(sto, T):
    """
    ...
    :class:`pybamm.Symbol`
        Solid diffusivity
   """
   # "piecewise coin" function for spherical model
    y0 = -15.03
    A4 = 1.187
    sigma4 = 0.02648
    ...
    return (sto < limit) * (D_ref_low * arrhenius) + (sto >= limit) * (D_ref_high * arrhenius)